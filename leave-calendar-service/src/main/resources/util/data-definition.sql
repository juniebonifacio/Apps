...
INSERT INTO EMPLOYEE_TIMEOFF (OWNER_ID, TIMEOFF_ID, DESCRIPTION) values (1, 1, 'test');
--INSERT INTO EMPLOYEE_TIMEOFF (OWNER_ID, TIMEOFF_ID, DESCRIPTION) values (2, 1, 'test');
